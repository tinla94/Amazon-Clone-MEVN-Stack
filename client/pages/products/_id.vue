        ...
        <div class="a-spacing-top-medium">
                        ...
                        <li>
                            <span class="a-list-item">
                                <a class="a-link-normal a-color-tertiary" href="#">
                                    {{ product.category ? product.category.type : 'Unknown' }}
                                </a>
                            </span>
                        </li>
                        <li>
            ...
            <div class="container-fluid">
                <div class="dp-container">
                    <div class="row">
                        <!-- First 3 grids - Product Image and Author's section -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                                <div class="smallAuthorImageContainer">
                                                    <a href="#">
                                                        <img 
                                                            :src="product.owner ? product.owner.photo : '/img/userdefaulticon.png'" 
                                                            class="img-fluid" />
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-4 col-lg-3 col-md-3 col-sm-3 col-3">
                                                <div class="authorNameCol">
                                                    <a href="#">
                                                        {{ product.owner ? product.owner.name : 'Admin' }}
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="a-spacing-top-small">
                                            <div class="a-section a-spacing-none">
                                                <div class="a-section a-spacing-none a-spacing-top-mini">
                                                    This item ships to
                                                    <b>California</b>
                                                    <b>Get it by Monday, April 4 - Monday April 11</b>
                                    ...
                                    <span class="a-declarative">
                                        <a href="#" class="a-link-normal">
                                            <div class="a-row a-spacing-mini">
                                                <i class="fal fa-map-market-all"></i>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10 col-sm-8 col-8 pl-0">
                                        <div class="mainContent">
                                            <h3>Biography</h3>
                                            <div id="authorBio">My name is {{ product.owner ? product.owner.name : 'Admin' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
