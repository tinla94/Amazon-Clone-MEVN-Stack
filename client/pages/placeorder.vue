                      ...
                      <fieldset>
                        ...
                        <div class="a-spacing-mini tuesday">
                          ...
                          <span class="a-radio-label">
                            ...
                            <br />
                            <span class="a-color-secondary">$25.98&nbsp;-&nbsp;Shipping</span>
                          </span>
                        </div>
                      </fieldset>
                    </div>
...
<script>
  ...
  export default {
    ...
    async asyncData({ $axios, store }) {
      try {
        let response = await $axios.$post(
          '/api/shipment', 
          { shipment: "normal" }
        ); // set default to normal shipment

        store.commit('setShipment', { 
    ...
    methods: {
      async onChooseShipping(shipment, totalPrice) {
        try {
          let response = await this.$axios.$post('/api/shipment', { shipment, totalPrice }); // set default to normal shipment
