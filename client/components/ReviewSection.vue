    ...
    <div class="reviewsMedley">
      <div class="row">
        <div class="col-lg-4 col-md-5 col-sm-12">
          ...
          <div class="cr-widget-ACR" style="display: flex; flex-direction: row; align-items: center">
            ...
            <span class="a-button-base writeReviewButton cm-cr-button-wide">
              <span class="a-button-inner">
                  <nuxt-link 
                    ...
                    class="a-button-text"
                    role="button">Write a customer review
                  </nuxt-link>
              </span>
            </span>
          </div>
                ...
                <div class="genome-widget">
                  <a href="#">
                    ...
                    <div class="profile-content">
                      <span class="a-profile-name" style="font-weight: bold">{{ review.user.name ? review.user.name : 'Amazon User' }}</span>
                    </div>
                  </a>
                </div>
                <div class="a-row">
